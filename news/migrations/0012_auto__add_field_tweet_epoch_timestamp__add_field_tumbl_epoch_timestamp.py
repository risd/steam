...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tweet.epoch_timestamp'
        db.add_column(u'news_tweet', 'epoch_timestamp',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Tumbl.epoch_timestamp'
        db.add_column(u'news_tumbl', 'epoch_timestamp',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tweet.epoch_timestamp'
        db.delete_column(u'news_tweet', 'epoch_timestamp')

        # Deleting field 'Tumbl.epoch_timestamp'
        db.delete_column(u'news_tumbl', 'epoch_timestamp')
