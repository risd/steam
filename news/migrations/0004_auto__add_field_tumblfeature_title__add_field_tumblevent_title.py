...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TumblFeature.title'
        db.add_column(u'news_tumblfeature', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'TumblEvent.title'
        db.add_column(u'news_tumblevent', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TumblFeature.title'
        db.delete_column(u'news_tumblfeature', 'title')

        # Deleting field 'TumblEvent.title'
        db.delete_column(u'news_tumblevent', 'title')
