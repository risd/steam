...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Tumbl.formatted_timestamp'
        db.delete_column(u'news_tumbl', 'formatted_timestamp')

        # Adding field 'Tumbl.ticker_timestamp'
        db.add_column(u'news_tumbl', 'ticker_timestamp',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2013, 11, 1, 0, 0), max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Tumbl.formatted_timestamp'
        db.add_column(u'news_tumbl', 'formatted_timestamp',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2013, 11, 1, 0, 0), max_length=50),
                      keep_default=False)

        # Deleting field 'Tumbl.ticker_timestamp'
        db.delete_column(u'news_tumbl', 'ticker_timestamp')
