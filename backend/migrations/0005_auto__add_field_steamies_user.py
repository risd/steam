...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Steamies.user'
        db.add_column(u'backend_steamies', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='steamies', null=True, on_delete=models.SET_NULL, to=orm['auth.User'], blank=True, unique=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Steamies.user'
        db.delete_column(u'backend_steamies', 'user_id')
    ...
    models = {
        ...
        u'backend.steamies': {
            ...
            'level_1': ('django.db.models.fields.CharField', [], {'max_length': '3', 'null': 'True', 'blank': 'True'}),
