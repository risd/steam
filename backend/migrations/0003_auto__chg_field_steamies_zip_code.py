...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Steamies.zip_code'
        db.alter_column(u'backend_steamies', 'zip_code', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Steamies.zip_code'
        raise RuntimeError("Cannot reverse this migration. 'Steamies.zip_code' and its values cannot be restored.")
