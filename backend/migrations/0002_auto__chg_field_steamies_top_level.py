...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'backend_steamies', 'top_level', self.gf('django.db.models.fields.CharField')(max_length=6, null=True))

    def backwards(self, orm):

        # Changing field 'Steamies.top_level'
        db.alter_column(u'backend_steamies', 'top_level', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))
