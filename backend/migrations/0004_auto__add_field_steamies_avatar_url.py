...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Steamies.avatar_url'
        db.add_column(u'backend_steamies', 'avatar_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Steamies.avatar_url'
        db.delete_column(u'backend_steamies', 'avatar_url')
