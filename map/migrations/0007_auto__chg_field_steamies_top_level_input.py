...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Steamies.top_level_input'
        db.alter_column(u'map_steamies', 'top_level_input', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

    def backwards(self, orm):

        # Changing field 'Steamies.top_level_input'
        db.alter_column(u'map_steamies', 'top_level_input', self.gf('django.db.models.fields.CharField')(default='', max_length=75))
