...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'map', ['Institution'])

        # Adding model 'Individual'
        db.create_table(u'map_individual', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('first_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('last_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=100)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('institution', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['map.Institution'], null=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('email_subscription', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'map', ['Individual'])

        # Adding model 'Steamies'
        db.create_table(u'map_steamies', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('zip_code', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True)),
            ('avatar_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('top_level', self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True)),
            ('individual', self.gf('django.db.models.fields.related.OneToOneField')(related_name='individual', null=True, on_delete=models.SET_NULL, to=orm['map.Individual'], blank=True, unique=True)),
            ('institution', self.gf('django.db.models.fields.related.OneToOneField')(related_name='institution', null=True, on_delete=models.SET_NULL, to=orm['map.Institution'], blank=True, unique=True)),
            ...
            ('initiative', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['map.Initiative'], null=True, blank=True)),
        ))
        db.send_create_signal(u'map', ['Steamies'])


    def backwards(self, orm):
        # Deleting model 'Initiative'
        db.delete_table(u'map_initiative')

        # Deleting model 'Institution'
        db.delete_table(u'map_institution')

        # Deleting model 'Individual'
        db.delete_table(u'map_individual')

        # Deleting model 'Steamies'
        db.delete_table(u'map_steamies')
    ...
    models = {
        ...
        u'map.steamies': {
            ...
            'top_level': ('django.db.models.fields.CharField', [], {'max_length': '6', 'null': 'True', 'blank': 'True'}),
            ...
            'zip_code': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True', 'blank': 'True'})
        }
    }
