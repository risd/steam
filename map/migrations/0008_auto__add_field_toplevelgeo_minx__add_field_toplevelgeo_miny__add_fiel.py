...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TopLevelGeo.minx'
        db.add_column(u'map_toplevelgeo', 'minx',
                      self.gf('django.db.models.fields.DecimalField')(default=-999, max_digits=8, decimal_places=5),
                      keep_default=False)

        # Adding field 'TopLevelGeo.miny'
        db.add_column(u'map_toplevelgeo', 'miny',
                      self.gf('django.db.models.fields.DecimalField')(default=-999, max_digits=8, decimal_places=5),
                      keep_default=False)

        # Adding field 'TopLevelGeo.maxx'
        db.add_column(u'map_toplevelgeo', 'maxx',
                      self.gf('django.db.models.fields.DecimalField')(default=-999, max_digits=8, decimal_places=5),
                      keep_default=False)

        # Adding field 'TopLevelGeo.maxy'
        db.add_column(u'map_toplevelgeo', 'maxy',
                      self.gf('django.db.models.fields.DecimalField')(default=-999, max_digits=8, decimal_places=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TopLevelGeo.minx'
        db.delete_column(u'map_toplevelgeo', 'minx')

        # Deleting field 'TopLevelGeo.miny'
        db.delete_column(u'map_toplevelgeo', 'miny')

        # Deleting field 'TopLevelGeo.maxx'
        db.delete_column(u'map_toplevelgeo', 'maxx')

        # Deleting field 'TopLevelGeo.maxy'
        db.delete_column(u'map_toplevelgeo', 'maxy')
    ...
    models = {
        ...
        u'map.steamies': {
            ...
            'top_level_input': ('django.db.models.fields.CharField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
        ...
        u'map.toplevelgeo': {
            ...
            'maxx': ('django.db.models.fields.DecimalField', [], {'default': '-999', 'max_digits': '8', 'decimal_places': '5'}),
            'maxy': ('django.db.models.fields.DecimalField', [], {'default': '-999', 'max_digits': '8', 'decimal_places': '5'}),
            'minx': ('django.db.models.fields.DecimalField', [], {'default': '-999', 'max_digits': '8', 'decimal_places': '5'}),
            'miny': ('django.db.models.fields.DecimalField', [], {'default': '-999', 'max_digits': '8', 'decimal_places': '5'}),
