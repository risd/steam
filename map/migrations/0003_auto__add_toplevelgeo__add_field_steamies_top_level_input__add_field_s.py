...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Steamies.top_level'
        db.add_column(u'map_steamies', 'top_level',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='top_level', null=True, to=orm['map.TopLevelGeo']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Steamies.top_level'
        db.delete_column(u'map_steamies', 'top_level_id')
