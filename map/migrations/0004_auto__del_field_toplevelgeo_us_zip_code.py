...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TopLevelGeo.us_zip_code'
        db.delete_column(u'map_toplevelgeo', 'us_zip_code')


    def backwards(self, orm):
        # Adding field 'TopLevelGeo.us_zip_code'
        db.add_column(u'map_toplevelgeo', 'us_zip_code',
